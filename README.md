...
```js
import { jack } from '@zitterorg/animi-quidem'
// this works too:
// const { jack } = require('@zitterorg/animi-quidem')
...
folder](https://github.com/zitterorg/animi-quidem/tree/master/examples)
...
const j = jack({
  ...
  // if you want a number, say so, and @zitterorg/animi-quidem will enforce it
  .num({
    jobs: {
      short: 'j',
